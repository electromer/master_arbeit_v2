...
\begin{figure}[!htb]
	\centerline{
		\includegraphics[width=1.7\textwidth]{images/diff_GD_v2_new.eps}}
...
\begin{figure}[H]
	\centerline{
		\includegraphics[width=0.8\textwidth]{images/bad_case_3d.eps}}
...
\begin{figure}[H]
	\centerline{
		\includegraphics[width=1.1\textwidth]{images/bad_case_contour_ubuntu_new.eps}}
...
\begin{figure}[!h]
	\centering	
	\subfigure[]{\label{fig:wf_1}}{\includegraphics[height=0.5\textwidth]{images/wf1_new.eps}} 	\subfigure[]{\label{fig:wf_0}}{\includegraphics[height=0.5\textwidth]{images/wf0_new.eps}} 	 	
...
and the fourth joint %($\frac{\partial {m_u(\mathbf{q})}}{\partial{\mathbf{q_{4}}}}$) 
...
\begin{figure}[!htb]
	\centerline{
		\includegraphics[width=0.7\textwidth]{images/1D_new.eps}}
...
\begin{figure}[!htb]
	\centerline{
		\includegraphics[width=0.8\textwidth]{images/JLA_weighting_v2_new.eps}}
...
\begin{table}[!h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{@{}|c|c|c|c|c|c|c|c|@{}}
			\toprule
			&                                      & \multicolumn{2}{c|}{\textbf{GD}}                                                                                                          & \multicolumn{2}{c|}{\textbf{DFP}}                                                                                                          & \multicolumn{2}{c|}{\textbf{BFGS}}                                                                                                        \\ \cmidrule(l){3-8} 
			\multirow{-2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Initial \\ configuration\end{tabular}}} & \multirow{-2}{*}{\textbf{Direction}} & \textbf{\begin{tabular}[c]{@{}c@{}}Ending\\ reason\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Iterations\\ required\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Ending \\ reason\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Iterations\\ required\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Ending\\ reason\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Iterations\\ required\end{tabular}} \\ \midrule
			A                                                                                           & x                                    & 3 zigzags                                                        & 94                                                                     & 3 zigzags                                                         & 81                                                                     & 3 zigzags                                                        & \cellcolor[HTML]{34FF34}\textbf{77}                                    \\ \midrule
